<?php
$content .= '<div class="pbs_rk_post_row_l2">';
		...
		if ( $result-> have_posts() ) :
			...
			while ( $result->have_posts() ) : $result->the_post();
				...
				$content .= '<div class="pbs_rk_post_col_l2">';
				$content .= '<div class="pbs_rk_post_inner_left_l2">';
				$content .= '<img src="'. $post_image .'" class="pbs_rk_post_image"/>';
				$content .= '</div>';
				$content .= '<div class="pbs_rk_post_inner_right_l2">';
				...
				if($hide_category == 'no')
					$content .= '<span class="pbs_rk_post_meta_slash">|</span><span class="pbs_rk_post_meta_category"><a href="'. get_category_link( $cat_id ) .'">'. $cat_name .'</a></span>';
