<?php
$content .= '<div class="pbs_rk_post_row_l4">';
		...
		if ( $result-> have_posts() ) :
			...
			while ( $result->have_posts() ) : $result->the_post();
				...
				$content .= '<div class="pbs_rk_post_col_l4">';
				$content .= '<div class="pbs_rk_post_inner_left_l4">';
				...
				$content .= '</div>';
				$content .= '<div class="pbs_rk_post_inner_right_l4">';
				$content .= '<a href="'. get_the_permalink() .'" rel="bookmark" class="pbs_rk_post_title">';
				$content .= '<h2>'. get_the_title() .'</h2>';
				$content .= '</a>';
				
				if($show_author == 'yes')
					$content .= '<p class="pbs_rk_post_meta"><span class="pbs_rk_post_meta_author"><a href="'. get_author_posts_url( $author_id ) .'">'. get_the_author_meta( 'display_name', $author_id ) .'</a></span></p>';
